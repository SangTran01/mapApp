...
// Check to make sure the infowindow is not already opened on this marker.
    if (infowindow.marker != marker) {
      ...
      '<div id="content">' + 
        ...
        '<p><b>From Yelp</b></p>' +
        '<p>' + yelpInfo.location.display_address[0] + '</p>' +
        '<p>' + yelpInfo.location.display_address[1] + '</p>' +
        '<p>' + yelpInfo.location.display_address[2] + '</p>' +
        '<p>' + yelpInfo.location.display_address[3] + '</p>' +
        '<p>' + yelpInfo.location.display_address[4] + '</p>' +
        '<p><b>Rating</b></p>' +
